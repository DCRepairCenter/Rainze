...
> **创建日期**: 2025-12-29
> **最后更新**: 2025-12-30
> **关联PRD**: PRD-Rainze.md v3.1.0 §0.0, §0.15.4
...
### 1.2 Rust/Python边界契约 ⭐新增

> **参考**: PRD §0.15.4 Rust/Python边界契约
> **接口定义**: `core.contracts.rust_bridge`

| 操作 | 执行层 | 理由 | Python回退 |
|------|--------|------|------------|
| FAISS索引操作 | **Rust** | 性能关键 | faiss-cpu Python |
| 向量重排序 | **Rust** | 计算密集 | 简化排序 |
| 批量向量化队列 | **Rust** | 高并发 | 串行处理 |
| CPU/内存监控 | **Rust** | 系统调用 | psutil |
| 全屏/会议检测 | **Rust** | Windows API | 跳过检测 |
| 中文分词 | **Rust** | 性能 | jieba |
| 实体词检测 | **Rust** | 性能 | 正则匹配 |
